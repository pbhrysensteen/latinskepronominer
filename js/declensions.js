...
var words = [
    ...
    new Word("fenestra", "fenestrae", "fenestram", "fenestras", "fenestrae", "fenestrarum", "fenestrae", "fenestris", "fenestra", "fenestris", "vindue f1",1 ),
    new Word("umbra", "umbrae", "umbram", "umbras", "umbrae", "umbrarum", "umbrae", "umbris", "umbra", "umbris", "skygge f1", 1),
    new Word("terra", "terrae", "terram", "terras", "terrae", "terrarum", "terrae", "terris", "terra", "terris", "land f1", 1),
    new Word("taberna", "tabernae", "tabernam", "tabernas",  "tabernae", "tabernarum", "tabernae", "tabernis","taberna", "tabernis", "butik f1", 1),
    new Word("charta", "chartae", "chartam", "chartas",  "chartae", "chartarum", "chartae", "chartis","charta", "chartis", "kort f1", 1),
    ...
    new Word("poeta", "poetae", "poetam", "poetas", "poetae", "poetarum", "poetae", "poetis", "poeta", "poetis", "digter m1",1),
